...
function isPrefix(message) { return !(!message.content.startsWith(configuration.prefix) || message.author.bot); }
...
function getArgs(message) { return message.content.slice(configuration.prefix.length).trim().split(/ +/); }
